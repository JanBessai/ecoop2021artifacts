...
public class M7Test {
    ...
    public interface TestTemplate extends M6Test.TestTemplate {
        default void test() {
            ...
            Assertions.assertEquals(1000.0, new Lit(10.0).powby_old(new Lit(3.0)).eval(), 0.0);

            Assertions.assertEquals(28561.0, new Add(new Lit(1.0), new Lit(12.0)).powby(new Lit(4.0)).eval(), 0.0);
        }
    }
