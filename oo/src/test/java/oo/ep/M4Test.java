...
public class M4Test {
    public interface TestTemplate extends M3Test.TestTemplate {
        default void test() {
            ...
            Assert.assertEquals(new Divd(new Divd(new Lit(5.0), new Lit(7.0)), new Sub(new Lit(7.0), new Mult(new Lit(2.0), new Lit(3.0)))).collect(), Arrays.asList(5.0, 7.0, 7.0, 2.0, 3.0));
            Assert.assertEquals(new Add(new Lit(0.0), new Lit(0.0)).collect(), Arrays.asList(0.0, 0.0));
            Assert.assertEquals(new Neg(new Lit(0.0)).collect(), Collections.singletonList(0.0));
            Assert.assertEquals(new Mult(new Lit(1.0), new Lit(12.0)).collect(), Arrays.asList(1.0, 12.0));
            Assert.assertEquals(new Mult(new Lit(13.0), new Lit(1.0)).collect(), Arrays.asList(13.0, 1.0));
