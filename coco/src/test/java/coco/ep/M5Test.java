...
public class M5Test {
    ...
    public interface TestTemplate<FT> extends coco.ep.m5.Factory<FT>, M4Test.TestTemplate<FT> {
        default void test() {
            ...
            org.junit.Assert.assertTrue(convert(convert(this.mult(this.mult(this.lit(2.0), this.lit(1.0)), this.add(this.lit(0.0), this.lit(7.0)))).simplify()).astree().equals(new Node(2409808, new Node(76407, new Leaf<>(2.0)), new Node(76407, new Leaf<>(7.0)))));
        }
    }
