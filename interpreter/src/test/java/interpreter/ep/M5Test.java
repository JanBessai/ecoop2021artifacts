    ...
    public class M5Test {
        public interface TestTemplate extends M4Test.TestTemplate {
            default void test() {
                ...
                org.junit.jupiter.api.Assertions.assertEquals(lit1.idz(), lit2.idz());
                org.junit.jupiter.api.Assertions.assertEquals(mult1.idz(), mult(lit1, lit2).idz());
                org.junit.jupiter.api.Assertions.assertEquals(divd1.idz(), divd(lit1, lit2).idz());
                org.junit.jupiter.api.Assertions.assertEquals(sub1.idz(), sub(lit1, lit2).idz());
                org.junit.jupiter.api.Assertions.assertEquals(add1.idz(), add(lit1, lit2).idz());
                org.junit.jupiter.api.Assertions.assertEquals(neg1.idz(), neg(lit2).idz());
                ...
                org.junit.jupiter.api.Assertions.assertEquals(m3, tree3);
