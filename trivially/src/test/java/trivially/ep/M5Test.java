...
public class M5Test {
    ...
    public void testTest() {
        ...
        Assert.assertEquals("((-2.0)-((1.0-976.0)*((1.0*976.0)+(1.0/3.0))))", this.sub(this.neg(this.lit(2.0)), this.mult(this.sub(this.lit(1.0), this.lit(976.0)), this.add(this.mult(this.lit(1.0), this.lit(976.0)), this.divd(this.lit(1.0), this.lit(3.0))))).prettyp());
