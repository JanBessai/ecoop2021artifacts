...
public class CollectPower implements VisitorPower<List<Double>> {

    public CollectPower() {
    }

    public List<Double> visit(Power exp) {
    ...
    public ev.ep.CollectPower makeCollect() {
        return new ev.ep.CollectPower();
    }
}
