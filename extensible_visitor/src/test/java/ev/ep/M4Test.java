...
public class M4Test {
    ...
    public interface TestTemplate extends M3Test.TestTemplate {
        default void test() {
            ...
            Assert.assertEquals("0.0", expr2.accept(makeSimplify()).accept(makePrettyp()));

            Divd expr3 = new Divd(new Lit(3.0), new Divd(new Lit(6.0), new Lit(2.0)));
            Assert.assertEquals("1.0", expr3.accept(makeSimplify()).accept(makePrettyp()));

            Neg expr4 = new Neg(expr1);
            Assert.assertEquals("(-3.0)", expr4.accept(makeSimplify()).accept(makePrettyp()));

            Add expr6 = new Add(new Lit(-2.0), new Lit(2.0));
            Assert.assertEquals("0.0", expr6.accept(makeSimplify()).accept(makePrettyp()));

            Add expr7 = new Add(new Lit(-2.0), new Lit(0.0));
            Assert.assertEquals("-2.0", expr7.accept(makeSimplify()).accept(makePrettyp()));

            Add expr8 = new Add(new Lit(-2.0), new Lit(-5.0));
            Assert.assertEquals("(-2.0+-5.0)", expr8.accept(makeSimplify()).accept(makePrettyp()));

            Sub sub2 = new Sub(new Lit(3.0), new Lit(3.0));
            Assert.assertEquals("0.0", sub2.accept(makeSimplify()).accept(makePrettyp()));

            Neg neg2 = new Neg(new Lit(0.0));
            Assert.assertEquals("0.0", neg2.accept(makeSimplify()).accept(makePrettyp()));

            Mult left = new Mult(new Lit(3.0), new Lit(1.0));
            Mult right = new Mult(new Lit(1.0), new Lit(9.0));
            Divd expr5 = new Divd(left, right);
            Assert.assertEquals("(3.0/9.0)", expr5.accept(makeSimplify()).accept(makePrettyp()));

            Assert.assertEquals(new Divd(new Divd(new Lit(5.0), new Lit(7.0)), new Sub(new Lit(7.0), new Mult(new Lit(2.0), new Lit(3.0)))).accept(makeCollect()), Arrays.asList(5.0, 7.0, 7.0, 2.0, 3.0));
            Assert.assertEquals(new Add(new Lit(0.0), new Lit(0.0)).accept(makeCollect()), Arrays.asList(0.0, 0.0));
            Assert.assertEquals(new Neg(new Lit(0.0)).accept(makeCollect()), Collections.singletonList(0.0));
            Assert.assertEquals(new Mult(new Lit(1.0), new Lit(12.0)).accept(makeCollect()), Arrays.asList(1.0, 12.0));
            Assert.assertEquals(new Mult(new Lit(13.0), new Lit(1.0)).accept(makeCollect()), Arrays.asList(13.0, 1.0));
            ...
            Assert.assertEquals("(5.0*1296.0)", mult1.accept(makePrettyp()));

            Divd divd1 = new Divd(new Lit(5.0), threeDeep);
            divd1.accept(makeTruncate(1));
            Assert.assertEquals("(5.0/1296.0)", divd1.accept(makePrettyp()));

            Neg neg1 = new Neg(threeDeep);
            neg1.accept(makeTruncate(1));
            Assert.assertEquals("(-1296.0)", neg1.accept(makePrettyp()));

            Sub sub1 = new Sub(new Lit(5.0), threeDeep);
            sub1.accept(makeTruncate(1));
            Assert.assertEquals("(5.0-1296.0)", sub1.accept(makePrettyp()));
            ...
            Assert.assertTrue(base.accept(makePrettyp()).equals(baseBeforeTrunc));
            ...
            Assert.assertTrue(larger.accept(makePrettyp()).equals(largerBeforeTrunc));

            Neg nd1 = new Neg(new Lit(1.0));
            Neg nd2 = new Neg(nd1);
            Neg nd3 = new Neg(nd2);
            Assert.assertEquals("(-(-(-1.0)))", nd3.accept(makePrettyp()));
            ...
            Assert.assertEquals( base.accept(makePrettyp()), baseTrunc.accept(makePrettyp()));
