...
public abstract interface Divd<V> extends vita.ep.m4.Divd<V>, Exp<V> {
    ...
    public default String prettyp() {
        return vita.ep.m4.Divd.super.prettyp();
    }

    public default Exp<V> simplify() {
        return this.convert(vita.ep.m4.Divd.super.simplify());
    }

    public default List<Double> collect() {
        return vita.ep.m4.Divd.super.collect();
    }
    ...
    public default Double eval() {
        return vita.ep.m4.Divd.super.eval();
    }
}
