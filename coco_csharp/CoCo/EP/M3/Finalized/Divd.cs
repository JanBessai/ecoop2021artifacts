namespace EP.M3.Finalized {
    public class Divd : EP.M2.Finalized.Exp, EP.M3.Divd<EP.M2.Finalized.Exp>, Factory {
        private EP.Exp<EP.M2.Finalized.Exp> left;
        private EP.Exp<EP.M2.Finalized.Exp> right;

        public Divd(EP.Exp<EP.M2.Finalized.Exp> _left, EP.Exp<EP.M2.Finalized.Exp> _right) {
            this.left = _left;
            this.right = _right;
        }
